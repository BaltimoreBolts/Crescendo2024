...
public class Constants {
  ...
  public static class kSwerve {
    ...
    // THEY HAD IT AT 19.5 SO SWERVE PID VALUES ARE PROBABLY OFF
    public static final double TRACK_WIDTH = Units.inchesToMeters(
        22.75); // Width of the drivetrain measured from the middle of the wheels.

    public static final double WHEEL_BASE = Units.inchesToMeters(
        22.75); // Length of the drivetrain measured from the middle of the wheels.
    ...
    public static final double ANGLE_GEAR_RATIO =
        (150 / 7) / 1.0; // THEY HAD IT AT 12.8:1 -- not sure why
    ...
    /**
     * //NOTE FROM PERVIOUS WRITERS WHO USED CAN CODERS Module specific constants. CanCoder offset
     * is in DEGREES, not radians like the rest of the repo. This is to make offset slightly more
     * accurate and easier to measure.
     */

    // mod 0 = back right
    public static final SwerveModuleConstants MOD_0_Constants =
        new SwerveModuleConstants(5, 4, 1, Rotation2d.fromDegrees(205.0));
    // mod 1 = back left
    public static final SwerveModuleConstants MOD_1_Constants =
        new SwerveModuleConstants(7, 6, 2, Rotation2d.fromDegrees(202.9));

    // mod 2 = front left
    public static final SwerveModuleConstants MOD_2_Constants =
        new SwerveModuleConstants(9, 8, 3, Rotation2d.fromDegrees(226.0));

    // mod 3 = front right
    public static final SwerveModuleConstants MOD_3_Constants =
        new SwerveModuleConstants(3, 2, 0, Rotation2d.fromDegrees(171.5));
  }
